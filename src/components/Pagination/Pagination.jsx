...
export default class Pagination extends Component {
  ...
  render() {
    ...
    const paginationItem = (className, page, text) => (
      <PaginationItem
        className={className} display={text.toString()}
        key={text} page={page} onPageChange={onPageChange}
      />
    );
    const pages = this.pageRange(currentPage, total, pagesToDisplay).map((page) => {
