...
// import * as surveyActions from 'redux/modules/claim';
...
@reduxForm({
  ...
  // fields: ['name', 'ID', 'gender', 'race', 'birth', 'address', 'authority', 'expire'],
...
class ClaimForm extends Component {
  ...
  render() {
    const {
      ...
      // fields: {name, email, occupation, currentlyEmployed, sex},
      // fields: {name, ID, gender, race, birth, address, authority, expire},
      // fields: {name, ID, gender, issueDate, authority, expiryDate},
      fields: {name, ID, gender, issueDate, expiryDate, authority},
      // active,
      handleSubmit,
      // invalid,
