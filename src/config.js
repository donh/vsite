...
module.exports = Object.assign({
  ...
  app: {
    title: 'vChain',
    description: 'Hottest blockchain on the earth.',
    head: {
      titleTemplate: 'vChain: %s',
      meta: [
        {name: 'description', content: 'Hottest blockchain on the earth.'},
        {charset: 'utf-8'},
        {property: 'og:site_name', content: 'vChain demo site'},
        // {property: 'og:image', content: 'https://vchain.com/logo.jpg'},
        {property: 'og:locale', content: 'en_US'},
        {property: 'og:title', content: 'vChain'},
        {property: 'og:description', content: 'Hottest blockchain on the earth.'},
